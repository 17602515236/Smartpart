...
#else
#define NSS_IOPORT                                  LORA_NSS_GPIO_Port
#define NSS_PIN                                     LORA_NSS_Pin
#endif
...
#else
#define DIO1_IOPORT                                 LORA_DIO1_GPIO_Port
#define DIO1_PIN                                    LORA_DIO1_Pin
#endif
...
#define DIO2_PIN                                    GPIO_Pin_2
#else
#define DIO2_IOPORT									LORA_DIO2_GPIO_Port
#define DIO2_PIN									LORA_DIO2_Pin
#endif
